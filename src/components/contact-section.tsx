          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h4 className="font-medium" data-testid="contact-email-label">
                    {t("email")}
                  </h4>
                  <p
              ...
              >
                ...
                <div>
                  ...
                  <p
                    className="text-muted-foreground"
                    data-testid="contact-location-value"
                  >
                    {t("location")}
                  </p>
                </div>
              ...
              >
                ...
                <div>
                  <h4
                    className="font-medium"
                    data-testid="contact-response-label"
                  >
                    {t("responseTime")}
                  </h4>
                  <p
                    className="text-muted-foreground"
                    data-testid="contact-response-value"
                  >
                    {t("responseTimeValue")}
                  </p>
                </div>
